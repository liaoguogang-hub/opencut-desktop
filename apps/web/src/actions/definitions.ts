...
const ACTION_NAMES: ReadonlySet<string> = new Set<string>(Object.keys(ACTIONS));

/**
 * Runtime guard used when deserialising persisted shortcut maps from JSON.
 * Accepts any defined action name; narrows to {@link TActionWithOptionalArgs}
 * which is the subset of actions we bind to keys.
 */
